...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#f8f9fa;border-left:3px solid #469D61;margin:20px 0;">
    <tr>
        <td style="padding:6px 15px;color:#666;font-size:14px;">Factura:</td>
        <td style="padding:6px 15px;font-weight:600;color:#555;font-size:14px;font-family:'JetBrains Mono',ui-monospace,Menlo,monospace;"><?= h($invoiceNumber) ?></td>
    </tr>
    <tr>
        <td style="padding:6px 15px;color:#666;font-size:14px;">Proveedor:</td>
        <td style="padding:6px 15px;font-weight:600;color:#555;font-size:14px;"><?= h($providerName) ?></td>
    </tr>
    <tr>
