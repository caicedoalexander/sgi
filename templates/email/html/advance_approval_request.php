...
<p style="margin:0 0 12px;">
    Se le ha asignado la aprobaci&oacute;n de la siguiente legalización de anticipo:
</p>
...
<table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#f8f9fa;border-left:3px solid #469D61;margin:20px 0;">
    <tr>
        <td style="padding:6px 15px;color:#666;font-size:14px;">Anticipo:</td>
        <td style="padding:6px 15px;font-weight:600;color:#555;font-size:14px;font-family:'JetBrains Mono',ui-monospace,Menlo,monospace;"><?= h($advanceCode) ?></td>
    </tr>
    <tr>
...
<p style="margin:0 0 12px;">
    Haga clic en el siguiente enlace para revisar y aprobar o rechazar esta legalización de anticipo:
</p>
