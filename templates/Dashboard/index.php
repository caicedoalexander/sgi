...
<div>
    ...
    <div class="row g-2">
        ...
        $quickLinks = [
            ...
            ['module' => 'employee_novelties',      'label' => 'Novedades',               'icon' => 'bi-journal-text',        'controller' => 'EmployeeNovelties',      'group' => 'primary'],
            ['module' => 'dian_crosschecks',        'label' => 'Cruces DIAN',             'icon' => 'bi-file-earmark-check',  'controller' => 'DianCrosschecks',        'group' => 'secondary'],
            ['module' => 'temporary_organizations',  'label' => 'Org. Temporales',         'icon' => 'bi-building',            'controller' => 'TemporaryOrganizations', 'group' => 'dark'],
            ['module' => 'novelty_types',           'label' => 'Tipos de Novedad',        'icon' => 'bi-list-check',          'controller' => 'NoveltyTypes',           'group' => 'dark'],
