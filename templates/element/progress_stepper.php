...
<div class="pipeline-progress">
    <div class="spi-stepper"<?= $isRejected ? ' data-rejected="true"' : '' ?>>
        <?php foreach ($statuses as $i => $s) : ?>
            ...
            ?>
        <div class="spi-step" data-state="<?= $state ?>">
            <div class="spi-step-circle">
            ...
            <div>
                <span class="spi-step-label"><?= h($labels[$s] ?? $s) ?></span>
                <?php if ($badge) : ?>
            ...
            <div class="spi-step-connector" data-state="<?= $i < $currentIndex ? 'past' : 'future' ?>"></div>
            <?php endif; ?>
        <?php endforeach; ?>
    </div>
