 ...
 *
 * Fuente única del avatar del chat de observaciones (Invoices/edit): lo usan
 * tanto el render server-side (observation_chat_item.php) como el <template>
 * del JS en observations_drawer.php. Misma paleta/hash que el chip de
 * aprobador (invoice_edit/_approver_chip.php).
 *
