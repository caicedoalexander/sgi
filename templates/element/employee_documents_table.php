                ...
                <td class="text-end">
                    <div class="d-flex gap-1 justify-content-end">
                        <?= $this->Html->link(
                            ...
                            ['action' => 'downloadDocument', $employeeId, $doc->id],
                            ['class' => 'btn btn-sm btn-default', 'escape' => false, 'target' => '_blank', 'title' => 'Abrir']
                        ) ?>
                        <?php if ($canDelete): ?>
                        <?= $this->Form->postLink(
                            '<i class="bi bi-trash" aria-hidden="true"></i>',
                            ['action' => 'deleteDocument', $employeeId, $doc->id],
                            ['confirm' => '¿Eliminar este documento?', 'class' => 'btn btn-sm btn-danger', 'escape' => false, 'title' => 'Eliminar']
                        ) ?>
                        <?php endif; ?>
                    </div>
                </td>
