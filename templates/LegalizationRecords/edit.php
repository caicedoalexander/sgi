    ...
    <div class="card-body p-4" style="padding-top:0 !important;">
        ...
        <div class="mb-4">
            ...
            <div class="card card-body mb-3" style="border-top:2px solid var(--primary-color);">
                <?= $this->Form->create(null, ['url' => ['controller' => 'LegalizationPayments', 'action' => 'addPayment', $record->id]]) ?>
                <div class="row g-3">
                    <div class="col-md-4">
            ...
            <?php if (!empty($record->legalization_payments)): ?>
            <div style="border:1px solid var(--border-color);border-top:2px solid var(--primary-color);">
                <table class="table table-sm mb-0">
                    ...
                    <tbody>
                        <?php foreach ($record->legalization_payments as $payment): ?>
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <?= $this->Form->postLink(
                                    ...
                                    ['controller' => 'LegalizationPayments', 'action' => 'authorizePayment', $record->id, $payment->id],
                                    ['class' => 'btn btn-sm btn-outline-success', 'escape' => false, 'confirm' => '¿Autorizar este pago?']
                                ) ?>
                                <?= $this->Form->postLink(
                                    '<i class="bi bi-x-lg me-1"></i>Rechazar',
                                    ['controller' => 'LegalizationPayments', 'action' => 'rejectPayment', $record->id, $payment->id],
