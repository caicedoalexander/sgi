...
<div class="sgi-page-header d-flex justify-content-between align-items-center">
    <span class="sgi-page-title">Legalizaciones</span>
    <?php if (!empty($userPermissions['legalizations']['can_create'])): ?>
    <div>
        <?= $this->Html->link(
        ...
        <div class="row g-2 align-items-end">
            <div class="col-md-3">
                ...
                <input type="text" name="code" class="form-control form-control-sm"
                       value="<?= h($params['code'] ?? '') ?>" placeholder="LEG-2026-...">
            </div>
            <div class="col-md-2">
    ...
    <div class="table-responsive">
        <table class="table table-hover mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="6" class="text-center text-muted py-4">No hay registros de Legalización.</td>
                </tr>
                <?php else: ?>
