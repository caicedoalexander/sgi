...
<div class="card card-primary">
    <div class="card-body text-center p-5">
        <?php if ($success): ?>
            <i class="bi bi-check-circle" style="font-size:3rem;color:var(--primary-color);" aria-hidden="true"></i>
            <h4 class="mt-3" style="font-weight:700;color:var(--text-default);">Acción Completada</h4>
        ...
        <?php else: ?>
            ...
            <h4 class="mt-3" style="font-weight:700;color:var(--text-default);">Error</h4>
            <p style="color:var(--text-faint);font-size:.9rem;">
