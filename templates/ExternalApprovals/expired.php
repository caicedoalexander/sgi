...
<div class="card card-primary">
    <div class="card-body text-center p-5">
        <?php if ($unauthorized): ?>
            <i class="bi bi-shield-x" style="font-size:3rem;color:#dc3545;" aria-hidden="true"></i>
        ...
        <?php else: ?>
            <i class="bi bi-clock-history" style="font-size:3rem;color:#dc3545;" aria-hidden="true"></i>
