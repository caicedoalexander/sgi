...
use App\Service\LegalizationPaymentService;
use Cake\Http\Response;

class LegalizationPaymentsController extends AppController
{
    private LegalizationPaymentService $paymentService;
    ...
    {
        parent::initialize();
        $this->paymentService = new LegalizationPaymentService();
    }
    ...
    /**
     * Register a new payment for a legalization record.
     *
    ...
    public function addPayment(?string $recordId = null): ?Response
    {
        ...
        if ($roleName !== RoleConstants::TESORERIA && $roleName !== RoleConstants::ADMIN) {
            ...
            return $this->redirect(['controller' => 'LegalizationRecords', 'action' => 'edit', $recordId]);
        }
