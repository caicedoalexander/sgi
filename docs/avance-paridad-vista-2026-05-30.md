...
**Bajo retorno / opcional:** ~~A13~~ ✅, ~~C8~~ ✅, ~~C4~~ ✅ (B, no extender). Restan solo **C7** (`final readonly class`, cosmético) y **C9** (element de sub-tablas, ganancia marginal + riesgo visual).
