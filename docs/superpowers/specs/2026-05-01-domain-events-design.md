...
| Toda comunicación cruza el bus de eventos                                           | `grep "events->dispatch" src/Service/InvoicePipelineService.php src/Service/InvoicePaymentService.php src/Service/AdvanceLegalizationService.php` → 4 ocurrencias |
