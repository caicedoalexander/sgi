/**
 * SGI Dialogs — sustitutos basados en Bootstrap Modal para confirm/prompt/alert.
 *
 * Expone:
 *   - SgiDialogs.confirm(message)                  → Promise<boolean>
 *   - SgiDialogs.prompt({title, message, minLength, placeholder, required})
 *                                                  → Promise<string|null>
 *   - SgiDialogs.toast(message, type)              → void  (alert temporal estilo bootstrap)
 *
...
(function (global) {
    ...
    function confirmDialog(message) {
        ...
        var modalEl = ensureModal('sgiConfirmModal', function () {
            return '' +
    ...
    function promptDialog(opts) {
        ...
        var modalEl = ensureModal('sgiPromptModal', function () {
            return '' +
